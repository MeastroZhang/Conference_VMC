...
public:
    // Bitmap Loding and Initialize
	  ...
	  virtual void DrawBtnText(CDC * pDC, int mode);
...
*/
	...
	void SetTextStarDrawPos(int nPos);	// 设置文字开始画的位置 [2/15/2012 Jesse]
...
protected:
	...
	int m_nStarDrawPos;	// 文字开始画的位置 [2/15/2012 Jesse]
